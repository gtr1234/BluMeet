...
public class ClientActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button mSendButton = (Button) findViewById(com.iitrpr.BluMeet.R.id.send);
        ...
        mProgressDialog.setMessage("Looking for a Host");
    ...
    private void sendMessage() {
        ...
        try {
            byte[] messageBytes = profileString.getBytes();
        ...
        new SendImageThread(imagePath).start();
